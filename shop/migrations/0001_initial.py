    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('pen', 'Pen'), ('sticker', 'Sticker'), ('notepad', 'Notepad'), ('accessories', 'Accessories'), ('rug', 'Rug'), ('keychain', 'Keychain'), ('stand', 'Stand'), ('mug', 'Mug')], max_length=50)),
